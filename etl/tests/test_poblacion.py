...
provincial row, the four target municipios, and one excluded municipio
(Adolfo Alsina) to prove the filter works. Only the `2010` and `2022`
columns are kept -- `2022` is the actual Censo Nacional de Población,
Hogares y Viviendas 2022 count (see the dataset's own CKAN notes: "Datos
relativos a la población de la Provincia (Censo 2010 y Censo 2022) y su
proyección"), every other year in the real file is a linear
interpolation/projection this build never reads.
"""
